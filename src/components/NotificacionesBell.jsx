                ...
                <div className="absolute right-0 top-full mt-1 z-50 w-80 bg-white rounded-lg shadow-lg border border-gray-200 max-h-[420px] flex flex-col">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 flex-shrink-0">
                        <h3 className="font-semibold text-gray-800 text-sm">
                            Notificaciones{" "}
                            {noLeidas > 0 && <span className="text-indigo-600">({noLeidas})</span>}
                        </h3>
                        {noLeidas > 0 && (
                            <button
                    ...
                    <div className="overflow-y-auto flex-1">
                        ...
                        {notificaciones.map((n) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`h-8 w-8 rounded-full flex items-center justify-center flex-shrink-0 ${bg}`}
                                    >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p
                                            className={`text-sm font-medium ${n.leida ? "text-gray-600" : "text-gray-900"}`}
                                        >
                                            {n.titulo}
                                        </p>
                                        {n.mensaje && (
