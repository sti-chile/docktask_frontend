...
const ModuleDetail = ({ token, workspaceId, moduleId }) => {
    ...
    const { module, isModuleLoading, moduleTasks, actualizarModule, asignarTarea, removerTarea } =
    ...
    const fetchAllTasks = useCallback(async () => {
        ...
        try {
            const data = await createHttpClient(token).get(
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-semibold text-gray-800">Tareas · {totalTasks}</h2>
                    <button
