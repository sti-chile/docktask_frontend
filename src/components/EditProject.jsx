...
function EditProject({ token }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        const api = token ? createHttpClient(token) : httpClient
        api.put(`/api/v1/proyectos/${id}`, { ...project })
            .then(() => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <form
                ...
                className="w-full flex flex-col gap-4 bg-white rounded-lg shadow-md p-6"
            >
                <div className="mb-4">
                ...
                <div className="flex justify-end">
                    <button
                        type="submit"
                        className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-2 px-4 rounded-md transition-colors duration-200"
                    >
                        Actualizar
                    </button>
                </div>
