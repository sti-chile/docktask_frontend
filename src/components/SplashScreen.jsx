        ...
        >
            ...
            >
                ...
                >
                    ...
                    <g
                        style={{
                            animation: "float-up-right 3.5s ease-in-out infinite 0.5s",
                    ...
                    >
                        ...
                        <line
                            ...
                            strokeLinecap="round"
                            style={{
                                animation: "tick-minute 2s steps(1) infinite",
                                transformOrigin: "200px 110px",
                            }}
                        />
                        <line
                    ...
                    <g
                        style={{
                            animation: "float-left 3.8s ease-in-out infinite 1.5s",
                    ...
                    <path
                        d="M100 157 Q110 150 120 155"
                        stroke="#f9a8d4"
                        strokeWidth="1.2"
                        fill="none"
                    />
                    <path
                        d="M140 155 Q150 150 160 157"
                        stroke="#f9a8d4"
                        strokeWidth="1.2"
                        fill="none"
                    />
                    <path
                        d="M120 153 Q130 148 140 153"
                        stroke="#f9a8d4"
                        strokeWidth="1.2"
                        fill="none"
                    />
                    ...
                    <path
                        d="M73 182 L68 180 M73 188 L67 188 M73 194 L68 196"
                        stroke="#f87171"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        opacity="0.6"
                    ...
                    />
                    <path
                        d="M187 182 L192 180 M187 188 L193 188 M187 194 L192 196"
                        stroke="#f87171"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        opacity="0.6"
