    ...
    return (
        ...
        >
            ...
            <div className="relative">
                ...
                {/* Anillo de actividad */}
                <div
                    className={`absolute -inset-1 border-2 border-primary/30 rounded-full animate-ping ${isHovered ? "opacity-100" : "opacity-0"}`}
                ></div>
            </div>
            ...
            <div
                className={`absolute -top-1 -right-1 w-3 h-3 bg-primary rounded-full ${isHovered ? "animate-pulse" : ""}`}
            ></div>
        </button>
    )
}
