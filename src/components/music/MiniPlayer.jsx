...
const MiniPlayer = () => {
  ...
  const { currentTrack, isPlaying, currentTime, duration, togglePlay, next, prev, seek, formatTime } = useMusic();
    ...
    >
      ...
      >
        <div
          ...
          style={{ width: `${progress}%`, background: '#00ff00', boxShadow: '0 0 6px #00ff00' }}
        />
      </div>
      ...
      <div className="flex items-center px-4 py-2 gap-4">
          ...
          <div className="overflow-hidden whitespace-nowrap">
            <span
              ...
              style={{
                ...
                animation: currentTrack.title.length > 30 ? 'marquee 8s linear infinite' : 'none',
              }}
            >
              {currentTrack.title}
            </span>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <WinampButton onClick={togglePlay} title={isPlaying ? 'Pausa' : 'Reproducir'} primary>
            {isPlaying ? (
...
const WinampButton = ({ onClick, children, title, primary }) => (
  <button
    ...
    style={{
      ...
      boxShadow: 'inset 1px 1px 0 rgba(255,255,255,0.15), inset -1px -1px 0 rgba(0,0,0,0.5), 1px 1px 2px rgba(0,0,0,0.5)',
    ...
    onMouseDown={e => e.currentTarget.style.boxShadow = 'inset 1px 1px 0 rgba(0,0,0,0.5), inset -1px -1px 0 rgba(255,255,255,0.1)'}
    onMouseUp={e => e.currentTarget.style.boxShadow = 'inset 1px 1px 0 rgba(255,255,255,0.15), inset -1px -1px 0 rgba(0,0,0,0.5), 1px 1px 2px rgba(0,0,0,0.5)'}
    onMouseLeave={e => e.currentTarget.style.boxShadow = 'inset 1px 1px 0 rgba(255,255,255,0.15), inset -1px -1px 0 rgba(0,0,0,0.5), 1px 1px 2px rgba(0,0,0,0.5)'}
  >
    {children}
  </button>
);
