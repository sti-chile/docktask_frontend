...
const MusicPlayer = () => {
    ...
    return (
        <div
            className={`bg-music-bg text-music-text rounded-xl border-2 border-music-border shadow-2xl p-6 ${isMobile ? "mb-20" : ""}`}
        >
                            ...
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-mono">
                                    {currentTrack?.file_size
                                        ? `${(currentTrack.file_size / (1024 * 1024)).toFixed(1)} MB`
                                        : "—"}
                                </span>
                            </div>
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-mono uppercase">
                                    {currentTrack?.mime_type?.split("/")[1] || "MP3"}
                                </span>
                            </div>
                        </div>
                                    ...
                                    {playlist.map((track, idx) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-center">
                                                <div className="flex items-center space-x-3">
                                                    <div
                                                        className={`w-8 h-8 rounded-full flex items-center justify-center ${currentIndex === idx ? "bg-primary" : "bg-gray-700"}`}
                                                    >
            ...
            <div className="mt-8 pt-6 border-t border-music-border text-xs text-gray-500 flex justify-between">
                <div>
                    DockTask Music v1.0 •{" "}
                    {currentTrack ? `Reproduciendo: ${currentTrack.title}` : "En pausa"}
                </div>
